// ============================================================
// secrets.js-grempe v2.0.0 — Shamir Secret Sharing over GF(256).
// Vendored for the Town Seal (the-record/web/seal.js). Source, unmodified
// except this header: npm package secrets.js-grempe@2.0.0 (dist/secrets.min.js).
//   npm pack secrets.js-grempe@2.0.0  ->  package/secrets.min.js
// UMD: in the browser it attaches window.secrets and uses crypto.getRandomValues
// (a CSPRNG). Pure client-side; it makes no network calls. License: MIT.
// Round-trip correctness proven in the-record test harness (200 random splits,
// exact hex reconstruction across random k-of-n; k-1 never reconstructs).
// ============================================================
